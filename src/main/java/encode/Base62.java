...
public class Base62 {
    ...
    public byte[] decode(String message) {
        final byte[] indices = convert(message.getBytes(), STANDARD_BASE, TARGET_BASE);
        return translate(indices, alphabet);
    }
     ...
     * @return
     */
    public String encodeToString(final byte[] encoded) throws UnsupportedEncodingException {
        final byte[] prepared = translate(encoded, lookup);
        final byte[] decodeByte = convert(prepared, TARGET_BASE, STANDARD_BASE);
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] encoded = base62.encode("zhangmiddddddddddddddd".getBytes());

        String sss = base62.encodeToString("zhangmiddddddddddddddd".getBytes());
